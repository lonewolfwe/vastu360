  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="py-16 bg-gradient-to-r from-green-700 via-yellow-600 to-brown-500 text-white">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-5xl font-serif font-bold mb-4">About Vastu360</h1>
        ...
        <section className="py-16 bg-gray-100">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-serif font-bold mb-8">Our Vision</h2>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-serif font-bold mb-8 text-center">Our Technology</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-2xl font-serif font-semibold mb-4">AI-Driven Insights</h3>
                <p>
              ...
              <div>
                <h3 className="text-2xl font-serif font-semibold mb-4">Personalized Solutions</h3>
                <p>
              ...
              <div>
                <h3 className="text-2xl font-serif font-semibold mb-4">Seamless User Experience</h3>
                <p>
              ...
              <div>
                <h3 className="text-2xl font-serif font-semibold mb-4">Real-Time Analysis</h3>
                <p>
